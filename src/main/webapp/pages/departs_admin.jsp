        ...
        <div class="col-sm-4">
            <form method="post" action="#">
                ...
                <div align="left">
                    ...
                    <input type="text" class="form-control" placeholder=<fmt:message key="entity.number"/> name="dnum" id="dnum"
                           required>
                </div>
                <div align="left">
                ...
                <div align="rigth">
                    ...
                    <% if(msgError){ %> <img src="../images/error.png" alt="Error" width="64"><%=dnum+"   "%><fmt:message key="error.add"/>
                            <% } %>
                </div>
            </form>
        </div>
